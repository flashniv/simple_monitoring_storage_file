...
public interface AlertRepository extends JpaRepository<Alert, Long> {
    ...
    @Query(value = "select a.trigger_id from alert as a join trigger as t on t.id=a.trigger_id where a.alert_timestamp>now()-'7 day'\\:\\:interval and not t.suppressed group by a.trigger_id having count(*)>28", nativeQuery = true)
