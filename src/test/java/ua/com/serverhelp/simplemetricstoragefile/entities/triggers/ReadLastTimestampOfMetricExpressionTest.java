...
class ReadLastTimestampOfMetricExpressionTest extends AbstractTest {
    ...
    @Test
    void getJSON() {
        ReadLastTimestampOfMetricExpression readLastTimestampOfMetricExpression = new ReadLastTimestampOfMetricExpression("test.stage.db.item1", "{}");
    ...
    void initialize() throws ExpressionException {
        ...
        readLastTimestampOfMetricExpression.initialize("{\"metricName\":\"test.stage.db.item1\",\"parameterGroup\":\"{}\"}");
